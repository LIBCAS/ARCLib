...
>
    ...
    <xsl:variable name="amdSecs"
                  select="concat('file:///', $pathToSip,
                  '/amdsec?select=amd*.xml;recurse=no')"/>
                    ...
                    <xsl:element name="METS:mdWrap">
                        ...
                        <xsl:element name="METS:xmlData">
                            <xsl:element name="ARCLib:devices">
                                <xsl:for-each-group
                                        select="collection($amdSecs)/METS:mets/METS:amdSec/METS:digiprovMD/METS:mdWrap/
                    ...
                    <xsl:element name="METS:mdWrap">
                        ...
                        <xsl:element name="METS:xmlData">
                            <xsl:element name="ARCLib:eventAgents">
                                <xsl:for-each-group
                                        select="collection($amdSecs)/METS:mets/METS:amdSec/METS:digiprovMD/
