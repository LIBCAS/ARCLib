...
public class ArchivalStorageDelegateTest extends DelegateTest {
    ...
    public void before() throws IOException {
        ...
        archivalStorageDelegate.setIndexArclibXmlStore(solrArclibXmlStore);
        ...
        indexedFields.put(SolrArclibXmlDocument.DOCUMENT, documents);
        when(solrArclibXmlStore.findArclibXmlIndexDocument(anyString())).thenReturn(indexedFields);
