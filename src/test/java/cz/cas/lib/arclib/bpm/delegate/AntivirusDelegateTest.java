...
public class AntivirusDelegateTest extends DelegateTest {
    ...
    public void before() {
        ...
        when(delegateExecution.getVariable(BpmConstants.FormatIdentification.mapOfFilesToFormats))
                .thenReturn(new TreeMap<String, Utils.Pair<String, String>>());
    }
    ...
    public void testAntivirusOnSIP() throws IOException {
        ...
        variables.put(BpmConstants.FormatIdentification.mapOfFilesToFormats,new TreeMap<String, Utils.Pair<String, String>>());
    ...
    public void testClamConfigParser() throws IOException, ConfigParserException {
        ...
        Antivirus a = antivirusDelegate.initialize(jsonRoot, ingestWorkflow, delegateExecution);
    ...
    public void testClamConfigParserException() throws Exception {
        ...
        assertThrown(() -> antivirusDelegate.initialize(jsonRoot, ingestWorkflow, delegateExecution)).isInstanceOf(ConfigParserException.class);
    }
}
