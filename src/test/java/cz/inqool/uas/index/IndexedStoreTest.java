...
import static cz.inqool.uas.util.Utils.reverse;
import static helper.ThrowableAssertion.assertThrown;
import static java.util.Collections.emptyList;
import static org.hamcrest.Matchers.*;
import static org.hamcrest.core.Is.is;

public class IndexedStoreTest extends EsDbTest {
    ...
    public void filteringLocalDateTest() {
        ...
        // EQ
        Params params = new Params();
        params.setFilter(asList(new Filter("localDateAttribute", FilterOperation.EQ, "2016-11-26", null)));
        ...
        // NEQ
        params = new Params();
        params.setFilter(asList(new Filter("localDateAttribute", FilterOperation.NEQ, "2016-11-26", null)));
        ...
        // LT
        params = new Params();
        params.setFilter(asList(new Filter("localDateAttribute", FilterOperation.LT, "2017-03-01", null)));
        ...
        // GT
        params = new Params();
        params.setFilter(asList(new Filter("localDateAttribute", FilterOperation.GT, "2016-11-26", null)));
        ...
        // LTE
        params = new Params();
        params.setFilter(asList(new Filter("localDateAttribute", FilterOperation.LTE, "2016-12-01", null)));
        ...
        // GTE
        params = new Params();
        params.setFilter(asList(new Filter("localDateAttribute", FilterOperation.GTE, "2016-12-01", null)));
    ...
    public void filteringDependentTestsMultiValue() {
        getTemplate().putMapping(IndexedTestEntity.class);
        store.reindex();
    ...
    public void filteringANDORMultipleTest() {
        ...
        // OR
        params = new Params();
        params.setFilter(asList(new Filter(null, FilterOperation.OR, null, asList(
                new Filter("stringAttribute", FilterOperation.STARTWITH, "abra", null),
