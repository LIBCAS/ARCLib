...
import static cz.inqool.uas.util.HelperObj.A;
import static cz.inqool.uas.util.HelperObj.B;
...
public class UtilsTest {
    ...
    public void checkedTest() {
        ...
        checked(() -> {}, IllegalArgumentException::new);
        assertThrown(() ->
                checked(() -> { throw new Exception(); }, IllegalArgumentException::new)
    ...
    public void toInstantTest() {
        Instant a = LocalDateTime.of(2016, 1, 1, 12, 30, 15).atZone(ZoneId.systemDefault()).toInstant();
        Date date = Date.from(a);

        Instant instant = toInstant(date);
        assertThat(instant, is(a));
