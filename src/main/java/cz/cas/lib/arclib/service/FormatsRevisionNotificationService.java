...
@Slf4j
@Service
public class FormatsRevisionNotificationService implements DelegateAdapter<FormatsRevisionNotification> {
    private UserDetails userDetails;
    @Getter
    private FormatsRevisionNotificationStore delegate;
    @Getter
    ...
    public FormatsRevisionNotification save(FormatsRevisionNotification formatsRevisionNotification) {
        ...
        return delegate.save(formatsRevisionNotification);
    }
    ...
    private void scheduleFormatsRevisionNotificationJob(FormatsRevisionNotification formatsRevisionNotification) {
        ...
        delegate.save(formatsRevisionNotification);
    }
    ...
    public FormatsRevisionNotification find(String id) {
        FormatsRevisionNotification entity = delegate.find(id);
    ...
    @Inject
    public void setDelegate(FormatsRevisionNotificationStore delegate) {
    ...
    @Inject
    public void setFormatsRevisionNotificationScript(@Value("${arclib.formatsRevisionNotificationScript}")
