...
public class ExportRoutineService implements DelegateAdapter<ExportRoutine> {
    ...
    @Getter
    private ExportRoutineStore delegate;
    ...
    public ExportRoutine save(ExportRoutine exportRoutine) {
        ...
        return delegate.save(exportRoutine);
    }
    ...
    private String scheduleAipExportRoutineJob(ExportRoutine exportRoutine, boolean all) throws JsonProcessingException {
        ...
        Result<SolrArclibXmlDocument> result = aipQuery.getResult();
        List<SolrArclibXmlDocument> items = result.getItems();
    ...
    private String scheduleXmlExportRoutineJob(ExportRoutine exportRoutine) throws JsonProcessingException {
        ...
        for (SolrArclibXmlDocument item : items) {
    ...
    public ExportRoutine find(String id) {
        ExportRoutine entity = delegate.find(id);
    ...
    public ExportRoutine findByAipQueryId(String aipQueryId) {
        return delegate.findByAipQueryId(aipQueryId);
    }
    ...
    @Inject
    public void setDelegate(ExportRoutineStore delegate) {
    ...
    @Inject
    public void setAipExportScript(@Value("${arclib.exportRoutineAipExportScript}") Resource aipExportScript) {
        this.aipExportScript = aipExportScript;
    }

    @Inject
    public void setXmlExportScript(@Value("${arclib.exportRoutineXmlExportScript}") Resource xmlExportScript) {
