 ...
 * @author Karel Maesen
 */
public class PostgreSQL94SpatialDialect extends PostgreSQL94Dialect implements SpatialDialect {


    /**
     * Creates an instance
     */
    public PostgreSQL94SpatialDialect() {
        super();
