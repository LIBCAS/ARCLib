...
public class ArclibXmlGeneratorDelegate extends ArclibDelegate {
    ...
    public void executeArclibDelegate(DelegateExecution execution) throws DocumentException, IOException, ParserConfigurationException, SAXException {
        ...
        validator.validateArclibXml(new ByteArrayInputStream(arclibXml.asXML().getBytes()), sip.getId(), authorialId, sip.getVersionNumber(), previousVersionSipId);
        ...
        indexArclibXmlStore.createIndex(prettyPrint(arclibXml), producer.getId(), producer.getName(), user.getUsername(), null, isInDebugMode(execution));
        ...
        String indexedArclibXml = (String) ((ArrayList) arclibXmlIndexDocument.get(IndexedArclibXmlDocument.DOCUMENT)).get(0);
