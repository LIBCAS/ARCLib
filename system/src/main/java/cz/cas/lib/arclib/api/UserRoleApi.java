...
public class UserRoleApi {
    ...
    @ApiOperation(value = "Find Role [Perm.USER_RECORDS_READ]")
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "Create Role with permissions [Perm.USER_RECORDS_WRITE]")
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "OK", response = UserRole.class),
    })
    ...
    @ApiOperation(value = "Update Role with permissions [Perm.USER_RECORDS_WRITE]")
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "OK", response = UserRole.class),
            @ApiResponse(code = 404, message = "Entity not found for given ID")
    })
    ...
    @ApiOperation(value = "Delete Role [Perm.USER_RECORDS_WRITE]")
    @PreAuthorize("hasAuthority('" + Permissions.USER_RECORDS_WRITE + "')")
    ...
    @ApiOperation(value = "Gets all instances [Perm.USER_RECORDS_READ]",
    ...
    @ApiOperation(value = "Gets all assignable permissions [Perm.USER_RECORDS_READ]",
