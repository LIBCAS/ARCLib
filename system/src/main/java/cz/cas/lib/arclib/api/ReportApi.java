...
public class ReportApi {
    ...
    @ApiOperation(value = "Compiles and stores report template.", notes = "If the arclibXmlDs query param is set to true, " +
    ...
    public String save(@ApiParam(value = "Template file", required = true)
                       ...
                       @ApiParam(value = "arclibXmlDs")
                       @RequestParam(value = "arclibXmlDs", required = false, defaultValue = "false") boolean arclibXmlDs) throws IOException {

        try (InputStream is = template.getInputStream()) {
            return store.saveReport(name, template.getInputStream(), arclibXmlDs);
        }
    }
