...
');
INSERT INTO arclib_producer_profile(id, external_id, created, updated, producer_id, validation_profile_id, sip_profile_id, workflow_config, workflow_definition_id, name, debugging_mode_active)
